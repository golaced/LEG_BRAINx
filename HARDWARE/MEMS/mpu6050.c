...
mpu_fil_tmp[G_X]= IIR_I_Filter( mpu6050_tmp[G_X], InPut_IIR_gro[0], OutPut_IIR_gro[0], b_IIR_gro, IIR_ORDER+1, a_IIR_gro, IIR_ORDER+1);
mpu_fil_tmp[G_Y]= IIR_I_Filter( mpu6050_tmp[G_Y], InPut_IIR_gro[1], OutPut_IIR_gro[1], b_IIR_gro, IIR_ORDER+1, a_IIR_gro, IIR_ORDER+1);
mpu_fil_tmp[G_Z]= IIR_I_Filter( mpu6050_tmp[G_Z], InPut_IIR_gro[2], OutPut_IIR_gro[2], b_IIR_gro, IIR_ORDER+1, a_IIR_gro, IIR_ORDER+1);
